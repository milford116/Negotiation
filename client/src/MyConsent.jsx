...
export function MyConsent({ next }) {
  ...
  return (
    <div className="bg-[#fcf9f4] text-black px-8 py-12 min-h-screen font-sans">
      <div className="max-w-3xl mx-auto text-[1.05rem] leading-7">
        {/* Centered Heading */}
        ...
        {/* Section Flow */}
        <p className="text-1xl mb-1 anton-regular"><b>Study Description</b></p>
        <p className="mb-6">
          ...
          whom you will negotiate a remuneration-benefits package in a hypothetical job interview scenario. <br/><br />
          <b className="anton-regular">There will be three stages in the study:</b>
          <br />
          <b className="mb-1 anton-regular">Stage 1: Onboarding</b> <br/> You will answer a questionnaire about yourself (e.g., capturing demographic
          information and interests).
          <br />
          <b className="mb-1 anton-regular">Stage 2: Negotiation Task</b> <br/> You will chat with your counterpart to negotiate the specifics of the
          ...
          negotiation.
          <br />
          <b className="mb-1 anton-regular">Stage 3 : Offboarding</b> <br/>You will respond to a survey questionnaire to reflect on your negotiation
...
guided with instructions throughout the experiment.
  ...
  <span className="font-semibold">
    Please note: spam responses, low-effort answers, or behavior that suggests inattentiveness may result in exclusion from the study without compensation.
        ...
        <p className="mb-6"><b className="anton-regular"> Risks of Participation:</b> The risks of participation are minimal. In the unusual circumstance that you face inappropriate
...
subject will be dismissed without compensation and reported to Prolific.</p>

        <p className="mb-6"><b className="anton-regular">Benefits of Participation:</b> You can benefit from practicing your negotiation skills with your counterpart.</p>

        <p className="mb-6"><b className="anton-regular"> Data Confidentiality:</b>This study will use our custom-built website to collect your research data; therefore, Prolific will not
...
results with other researchers not directly listed in this protocol for further analysis.</p>

        <p className="mb-6"><b className="anton-regular">Voluntary Participation: </b> Your participation in this study is entirely voluntary. You are free to withdraw at any time, for
        whatever reason.</p>

        <p className="mb-6"><b className="anton-regular"> Contact: </b>For any questions, concerns, or complaints about this research, you may contact the research team
by sending a message in Prolific or emailing us at cssai.research@gmail.com. You can also
email the Principal Investigator, Dr. Raiyan Abdul Baten, at rbaten@usf.edu.</p>
        ...
        <div className="mt-10 flex justify-center ">
          <Button
            type="button"
            handleClick={handleConsent}
            primary
            disabled={!checked || hasConsented}
