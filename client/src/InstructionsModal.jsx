...
export function InstructionsModal({ onClose }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      ...
      <div className="bg-white w-11/12 max-w-3xl mx-auto rounded shadow-lg p-6 relative">
        <button
          onClick={onClose}
        ...
        <div className="h-96 overflow-y-auto space-y-4 text-gray-700">
          ...
          <p>
            <strong>New Offer Section:</strong>  
          ...
          <p>
            <strong>Submit Your Final Offer:</strong>  
...
The goal is to achieve a higher score than your opponent and “win” the negotiation!
          ...
          <p>
            <strong>Important Disclaimers or Additional Consent Info:</strong>  
